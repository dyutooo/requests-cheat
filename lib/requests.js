...
class Request {
  ...
  async GET(url, headers, proxie = null, recursive = false) {
    if (proxie) {
  ...
  async POST(url, headers = {}, data = {}, proxie = null, recursive = false) {
    if (proxie) {
      var dataHttpAgent = setProxy(proxie);
    } else {
      var dataHttpAgent = {};
  ...
  async PUT(url, headers = {}, data = {}, proxie = null, recursive = false) {
    if (proxie) {
      var dataHttpAgent = setProxy(proxie);
    } else {
      var dataHttpAgent = {};
